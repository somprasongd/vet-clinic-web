    ...
    <v-row class="pt-3" no-gutters>
        ...
        <v-card class="elevation-4" height="540">
          ...
          <div class="px-7 py-5">
            ...
            <v-list class="pa-0 px-5">
              <v-list-item v-for="list in itemNew" :key="list.index">
                <v-list-item-content>
      ...
      <!-- <v-col cols="7">
                <v-card height="540">
                    <div class="px-7">
                        <v-row dense>
                            <v-col cols="6"><v-text-field label="รหัส"></v-text-field></v-col>
                            <v-col cols="12"><v-text-field label="ข้อความ"></v-text-field></v-col>
                        </v-row>
                    </div>
